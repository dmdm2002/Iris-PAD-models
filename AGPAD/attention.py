...
class PAM(Layer):
    ...
    def build(self, input_shape):
        ...
        self.conv_b = Conv2D(1024//8, 1, use_bias=False, kernel_initializer='he_normal')
        self.conv_c = Conv2D(1024//8, 1, use_bias=False, kernel_initializer='he_normal')
        self.conv_d = Conv2D(1024, 1, use_bias=False, kernel_initializer='he_normal')
        # self.shape = input_shape.get_shape().as_list()
    ...
    def call(self, inputs, *args, **kwargs):
        ...
        # b = self.Conv2D(filters // 8, 1, use_bias=False, kernel_initializer='he_normal')(inputs)
        # c = self.Conv2D(filters // 8, 1, use_bias=False, kernel_initializer='he_normal')(inputs)
        # d = self.Conv2D(filters, 1, use_bias=False, kernel_initializer='he_normal')(inputs)
