...
parser.add_argument('-datasetPath', required=False, default='Z:/Iris_dataset/Warsaw_labeling_iris_data/innerclass/Proposed/1-fold', type=str)
parser.add_argument('-outputPath', required=False, default='Z:/backup/ckp/warsaw/Ablation/DNet/1-fold_5/', type=str)
...
lr_sched = optim.lr_scheduler.StepLR(solver, step_size=120, gamma=0.1)
